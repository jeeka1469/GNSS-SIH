...
class BroadcastOrbitComputer:
    ...
    def __init__(self):
        ...
        self.GM = 3.986005e14  # Earth's gravitational parameter (mÂ³/sÂ²)
...
def test_broadcast_computer():
    ...
    if position:
        ...
        if 20000000 < radius < 30000000:  # Reasonable GPS orbit range
            print("âœ“ Position computation appears reasonable")
        else:
            print("âš  Position may be incorrect - outside expected GPS orbit range")
    else:
        print("âœ— Position computation failed")
    ...
    if error < 1e-10:
        print("âœ“ Kepler equation solver working correctly")
    else:
        print("âš  Kepler equation solver may have issues")
